...
[svelte-table ](https://ui.shadcn.com/docs/components/data-table) yet simpler to configure (and less powerful) than  
[tezasr/datagrid](https://github.com/tzezar/datagrid).  Hence the modest designation as a data "table" rather than a data "grid" component.

What I wanted was the django experience: 
table and form views that would support CRUD automatically generated from my application data models
and interactive report views based on my computed views, requiring only a bit of per-view and per-column annotation.
